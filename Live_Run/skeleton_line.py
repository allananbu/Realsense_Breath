# -*- coding: utf-8 -*-
"""
Created on Mon Feb 15 21:05:59 2021
...
joints=scipy.io.loadmat('Depth_joints.mat')
jts=joints['Joints']
depth_im=np.load('Depth_image.npy')
...
#cv2.circle(depth,(ptx_5-12,pty_5-70),6,(255,0,0),4)


cv2.imshow('re',depth)
cv2.imwrite('Depth_Skeleton.png',depth)